...
当然，具体是哪个时间属性才是观测时间，可以观察一下文件的属性，如果有一个时间属性不同文件时不同的，那应该便是观测时间了。如果你想 **以文件的修改时间为观测时间** ，可以将[图3.1](#观测时间)LocalTime = os.stat(obs_Dir+obs_Source+'.txt').st_ctime中的 **ct_mtime改为st_mtime** 。
...
尽管有些乱，但仍可以看出几条旋臂，对比[图8.2](#银河系)，可以看出四条臂分别是英仙臂、外臂、人马臂以及太阳所在的猎户臂
...
黑色代表算法的唯一解，描绘出了英仙臂和外臂；蓝色和红色代表算法的两个解，个人认为部分的红色和部分的蓝色是对的，即人马臂以及太阳所在的猎户臂
